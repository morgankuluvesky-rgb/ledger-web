        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
                        <svg width="48" height="48" viewBox="0 0 64 64" fill="none">
                            ...
                            <path d="M32 4L8 16v16c0 14.4 10.24 27.84 24 32 13.76-4.16 24-17.6 24-32V16L32 4z" fill="url(#regLogoGrad)" />
                ...
                <p style={{ textAlign: 'center', marginTop: '24px', color: '#666' }}>
                    ...
                    <Link to="/login" style={{ color: '#14F195', textDecoration: 'none' }}>
                        Sign in
                    </Link>
                </p>
            </div>
